...
public interface CustomerService {
	...
	public String getLastLoginDate(String userId, boolean isSuccess,StringHolder lastLoginDate)
			throws Exception;

	public String addUser(Customer newUser, Group[] groups) throws Exception;

	public String updateUser(Customer newUser,
			 Group[] groups) throws Exception;

	public String customerAuthenticate(String userId,String userPassword,ObjectHolder userInfo) throws Exception;
